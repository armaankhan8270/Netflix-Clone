    ...
    <div>
      <div className="w-[1519px] h-[465px] justify-center bg-[#000000] border-[8px] border-[#333333]  ">
        <div className="flex w-[1100px] h-[325px] ml-[270px] mr-[270px]  mt-[70px]">
          ...
          <div className='bg-black w-[40%] bg-[url("https://asses.nflxext.com/ffe/siteui/acquisition/ourStory/fuji/desktop/tv.png")] bg-no-repeat bg-cover overflow-hidden'>
            {/* <img
            
              src="https://occ-0-3374-2164.1.nflxso.net/dnm/api/v6/19OhWN2dO19C9txTON9tvTFtefw/AAAABYjXrxZKtrzxQRVQNn2aIByoomnlbXmJ-uBy7du8a5Si3xqIsgerTlwJZG1vMpqer2kvcILy0UJQnjfRUQ5cEr7gQlYqXfxUg7bz.png?r=420"
              alt=""
              className="mt-14 -ml-32 h-[380px] w-[500px]"
            /> */}
            <img src="https://occ-0-3374-2164.1.nflxso.net/dnm/api/v6/19OhWN2dO19C9txTON9tvTFtefw/AAAABYjXrxZKtrzxQRVQNn2aIByoomnlbXmJ-uBy7du8a5Si3xqIsgerTlwJZG1vMpqer2kvcILy0UJQnjfRUQ5cEr7gQlYqXfxUg7bz.png?r=420" alt="" />
         
          </div>
          <div className="w-[50%] mt-12 ml-12">
