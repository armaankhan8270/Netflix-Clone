      ...
      <div className="w-[1519px] h-[500px] justify-center bg-[#000000] border-[6px] border-[#333333]  ">
        <div className="flex w-[1100px] h-[325px] ml-[270px] mr-[270px]  mt-[70px]">
          ...
          <div className=' w-[50%] -ml-24 flex grid-cols-1  overflow-hidden h-400px ' >
            ...
            />
            <div className="bg-black h-20 w-[300px] mt-44 -ml-[390px] flex  border-2 border-[#333333] rounded-md">
<img src="https://assets.nflxext.com/ffe/siteui/acquisition/ourStory/fuji/desktop/boxshot.png" className="w-[57px] h-[84px]" alt="" />
<div>

<p className="text-[17px]  pt-5 pl-2 text-white">Stranger Things </p>
<p className="text-[17px]  pl-2  text-blue-900 brightness-200">Downloading... </p>

</div>
<button className="pl-12 text-[20px] grayscale">⬇️</button>
            </div>
            a
          </div>
           
          <div className="w-[50%] mt-12 -mr-24">
